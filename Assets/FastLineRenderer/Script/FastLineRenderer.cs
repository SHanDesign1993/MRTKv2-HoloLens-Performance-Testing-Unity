...
namespace DigitalRuby.FastLineRenderer
{
    ...
    public class FastLineRenderer : MonoBehaviour
    {
        ...
        [Tooltip("True to use world space, false to use local space. Default is local space.")]
        ...
        public Mesh Mesh
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    obj.GetComponent<MeshFilter>().sharedMesh = value;
        ...
        private void UpdateMaterial()
        {
            ...
            else if (Material != previousMaterial)
            {
                ...
                if (canvasRenderer == null && !useCanvas)
                {
                    Material.DisableKeyword("USE_CANVAS");
                }
                else
                {
                    Material.EnableKeyword("USE_CANVAS");
                }
            }
            ...
            Material.SetFloat(animationSpeedId, AnimationSpeed);
            Material.SetFloat(uvxScaleId, LineUVXScale);
            Material.SetFloat(uvyScaleId, LineUVYScale);
            Material.SetFloat(glowAnimationSpeedId, GlowAnimationSpeed);
            ...
            if (ScreenRadiusMultiplier > 0.0f)
            {
                Material.EnableKeyword("ENABLE_SCREEN_RADIUS");
                Material.SetFloat(screenRadiusMultiplierId, ScreenRadiusMultiplier);
            }
            else
            {
                Material.DisableKeyword("ENABLE_SCREEN_RADIUS");
            }
        }
        ...
        private void AssignMaterialIds()
        {
            ...
            glowAnimationSpeedId = Shader.PropertyToID("_GlowAnimationSpeed");
