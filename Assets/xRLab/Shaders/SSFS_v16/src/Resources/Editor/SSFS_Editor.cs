...
public class SSFS_Editor : MaterialEditor
{
    ...
    public float stencilComp = 8, stencil = 0, stencilOp = 0;
    public float stencilWriteMask = 255, stencilReadMask = 255;
	...
	void ReadProperties()
	{
        ...
        m.BleedProperty("_StencilComp", ref stencilComp);
        m.BleedProperty("_Stencil", ref stencil);
        m.BleedProperty("_StencilOp", ref stencilOp);

        m.BleedProperty("_StencilWriteMask", ref stencilWriteMask);
        m.BleedProperty("_StencilReadMask", ref stencilReadMask);
	...
	void SetProperties()
	{
        ...
        m.PatchProperty("_StencilComp", stencilComp);
        m.PatchProperty("_Stencil", stencil);
        m.PatchProperty("_StencilOp", stencilOp);

        m.PatchProperty("_StencilWriteMask", stencilWriteMask);
        m.PatchProperty("_StencilReadMask", stencilReadMask);
	...
	public void DrawGeneralTab()
	{
        ...
        stencilComp = egui.FloatField("Stencil Comparison", stencilComp);
        stencil = egui.FloatField("Stencil ID", stencil);
        stencilOp = egui.FloatField("Stencil Operation", stencilOp);

        stencilWriteMask = egui.FloatField("Stencil Write Mask", stencilWriteMask);
        stencilReadMask = egui.FloatField("Stencil Read Mask", stencilReadMask);
    }
