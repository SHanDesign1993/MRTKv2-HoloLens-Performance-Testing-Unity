...
Shader "Particles/Standard Unlit (ForceNoShadowCasting)"
{
    Properties
    {
    ...
    Category
    {
        SubShader
        {
            Tags { "RenderType"="Opaque" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False"  "ForceNoShadowCasting" = "True" }
